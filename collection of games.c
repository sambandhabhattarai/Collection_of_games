...
int main()
     ...
     char playername[20];
     char mark;
      int player = 1,  choices;
     	
     	 printf("******************ENTER TO THE GAMING WORLD*************************\n");
     printf("            \n");
       printf("            \n");
         printf("            \n");
           printf("WE HAVE TWO TYPES OF GAMES\n");
       printf("            \n");
         printf("1.QUIZ GAME\n");
       printf("            \n");
       printf("2.TIC TAC TOE GAME\n");
      // printf("            \n");
         printf("            \n");
         printf("PRESS 1 FOR QUIZ GAME----------- AND------------- 2 FOR TIC TAC TOE GAME\n");
         	scanf("%d",&game);
     	switch(game){
		 case 1:
     //int countr,r,r1,count,i,n;
    ...
    else
{
   ...
   // char mark;
    do
    {
        ...
        if (choices == 1 && square[1] == '1')
            square[1] = mark;
            
        else if (choices == 2 && square[2] == '2')
            square[2] = mark;
            
        else if (choices == 3 && square[3] == '3')
            square[3] = mark;
            
        else if (choices == 4 && square[4] == '4')
            square[4] = mark;
            
        else if (choices == 5 && square[5] == '5')
            square[5] = mark;
            
        else if (choices == 6 && square[6] == '6')
            square[6] = mark;
            
        else if (choices == 7 && square[7] == '7')
            square[7] = mark;
            
        else if (choices == 8 && square[8] == '8')
            square[8] = mark;
            
        else if (choices == 9 && square[9] == '9')
            square[9] = mark;
